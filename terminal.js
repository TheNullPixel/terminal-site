...
about = [
  ...
  "I'm a frontend devloper from Belfast, UK. I'm a final year",
...
social = [
  ...
  'twitter        <a href="' +
    twitter +
    '" target="_blank">twitter/nullpixeldev' +
    "</a>",
  'github         <a href="' +
    github +
    '" target="_blank">github/null-pixel-dev' +
    "</a>",
  "<br>",
];

projects = ["<br>", "Coming soon!", "<br>"];
